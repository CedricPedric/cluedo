...
if acteerDiplomaVraag and AgeCheck and kleurVraag.lower() == 'geel' and ManOfVrouwVraag in ['Man', 'man', 'MAN'] and HaarVraag.lower() in ['blond', 'geel']:
    print('Je mag op auditie voor de rol van Kolonel van Geelen')

elif acteerDiplomaVraag and AgeCheck and kleurVraag.lower() == 'wit' and ManOfVrouwVraag.lower() == 'vrouw' and HaarVraag.lower() in ['wit', 'grijs']:
    print('Je mag op auditie voor de rol van Mevrouw de Wit')

elif acteerDiplomaVraag  and AgeCheck and kleurVraag.lower() == 'rood' and ManOfVrouwVraag.lower() == 'vrouw' and HaarVraag.lower() == 'zwart':
    print('Je mag op auditie voor de rol van Rosa Roodhart')

elif (acteerDiplomaVraag and AgeCheck and kleurVraag.lower() == 'paars' and ManOfVrouwVraag in ['Man', 'man', 'MAN'] and SnorVraag
and HaarVraag.lower() == 'grijs'):
    print('Je mag op auditie voor de rol van Professor Pimpel')

elif acteerDiplomaVraag and AgeCheck and kleurVraag.lower() == 'groen' and ManOfVrouwVraag in ['Man', 'man', 'MAN']:
    print('Je mag op auditie voor de rol van Dominee Groenewoud')

elif acteerDiplomaVraag and AgeCheck and kleurVraag.lower() == 'blauw' and ManOfVrouwVraag.lower() == 'vrouw' and HaarVraag.lower() == 'bruin':
